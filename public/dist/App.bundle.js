...
function typeAhead(search) {
  ...
  searchInput.addEventListener('input', function () {
    ...
    axios.get('/api/stores/search?q=' + this.value).then(function (res) {
...
(0, _autocomplete2.default)((0, _bling.$)("#address"), (0, _bling.$)("#address_lat"), (0, _bling.$)("#address_lng"));
